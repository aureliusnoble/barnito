...
/** Rule 3 (amended): a flat champion prize — enough to swing the top few places
 * (~20% of a typical full-tournament haul of ~10k), not to dominate the game. */
export const CHAMPION_POINTS = 2000;

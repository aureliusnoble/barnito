...
export default function MatchesBrowse() {
  const { state } = useEuro();
  ...
  return (
    <div className="space-y-4">
      <PageHead title="Matches" sub={`${PHASE_LABEL[phase]} — fixtures, results and who's picked what. 🌶️ marks games that could shake the table.`} />
